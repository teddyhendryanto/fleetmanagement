...
@section('breadcrumb')
  <div id="#breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('employees.create') }}" class="active">Buat Baru</a></li>
    </ol>
  </div>
@endsection
    ...
    <div class="col-md-12">
      <div id="panel-info" class="panel panel-default">
        ...
        <div id="panel-body" class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <form id="form" class="form" role="form" method="POST" action="{{ route('employees.store') }}">
                {{ csrf_field() }}
                @if(isset($data))
