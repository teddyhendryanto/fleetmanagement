...
@section('breadcrumb')
  <div id="#breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('vehicles.edit', Request::segment(4)) }}" class="active">Edit</a></li>
    </ol>
  </div>
@endsection
    ...
    <div class="col-md-12">
      <div id="panel-info" class="panel panel-default">
        ...
        <div id="panel-body" class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <form id="form" class="form" role="form" method="POST" action="{{ route('vehicles.update', $data->id) }}">
                {{ csrf_field() }}
                @if(isset($data))
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      value="{{ $data->license_plate }}" autocomplete="off" minlength="6">
                    </div>
                  </div>
                  <div class="col-md-3">
