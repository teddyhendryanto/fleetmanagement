...
@section('breadcrumb')
  <div id="#breadcrumb">
    <ol class="breadcrumb">
      ...
      <li><a href="{{ route('areas.edit', Request::segment(4)) }}" class="active">Edit</a></li>
    </ol>
  </div>
@endsection
    ...
    <div class="col-md-12">
      <div id="panel-info" class="panel panel-default">
        <div class="panel-heading">
          <a href="{{ route('areas.index') }}" class="btn btn-default">
            Back
          </a>
        </div>
        <div id="panel-body" class="panel-body">
          <div class="row">
            <div class="col-md-12">
              <form id="form" class="form" role="form" method="POST" action="{{ route('areas.update', $data->id) }}">
                {{ csrf_field() }}
                @if(isset($data))
                ...
                <div class="row">
                  <div class="col-md-3">
                    ...
                    <div class="form-group">
                      ...
                      value="{{ $data->area }}" autocomplete="off">
                    </div>
                  </div>
                  <div class="col-md-3">
